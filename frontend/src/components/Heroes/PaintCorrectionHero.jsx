...
import TeslaPaint from '../../assets/images/details/tesla-paint-correction.jpg';
...
const useStyles = createStyles((theme) => ({
  wrapper: {
    ...
    paddingTop: '150px',
    paddingBottom: '150px',
    backgroundImage: `url(${TeslaPaint})`,
...
const PaintCorrectionHero = () => {
  ...
  return (
    <div className={classes.wrapper}>
      ...
      REMOVE SWIRL MARKS, SCRATCHES AND WATER SPOT ETCHING
        </Title>
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 text-base font-semibold leading-7 text-white sm:grid-cols-2 md:flex lg:gap-x-6">
          ...
          <Link to="https://app.urable.com/virtual-shop/rB9FHJFIfifYgU8Ty9Yw/joHM8Dxh2Y2E9HsOXeF2" target="_blank"  style={{ textDecoration: 'none', display: 'flex', justifyContent: 'center' }}>
          <Button 
