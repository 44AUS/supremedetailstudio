...
import HeadlightProtectionFilm from '../../assets/images/ppf/dynostorm.jpeg';
...
const useStyles = createStyles((theme) => ({
  wrapper: {
    ...
    paddingTop: '150px',
    paddingBottom: '150px',
    backgroundImage: `url(${HeadlightProtectionFilm})`,
...
const HeadlightProtectionFilmHero = () => {
    ...
    <div className={classes.wrapper}>
      ...
      <Image src={Stek} alt="STEK" className={classes.partnerLogo} />
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 text-base font-semibold leading-7 text-white sm:grid-cols-2 md:flex lg:gap-x-6">
          ...
          <Link to="https://app.urable.com/virtual-shop/rB9FHJFIfifYgU8Ty9Yw/pOUCf7sLZ7O0rn1N9gsl" target="_blank"  style={{ textDecoration: 'none', display: 'flex', justifyContent: 'center' }}>
          <Button 
...
export default HeadlightProtectionFilmHero;