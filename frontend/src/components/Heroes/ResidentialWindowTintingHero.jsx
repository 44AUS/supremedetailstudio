...
const ResidentialTintingHero = () => {
  const { classes } = useStyles();

    const stats = [
    { number: '30%', label: 'HVAC Savings' },
    { number: '99%', label: 'UV Blocked' },
    ...
    <div className={classes.wrapper} data-testid="hero-section">
      ...
      <div className={classes.content}>
        ...
        <Text className={classes.description} data-testid="hero-description">
          Block up to 86% of solar heat, cut cooling costs by 30%, and protect your furniture from UV damage. Enjoy natural light without the downsides.
        </Text>
...
export default ResidentialTintingHero;
