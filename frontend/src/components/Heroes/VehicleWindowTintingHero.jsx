...
const VehicleWindowTintingHero = () => {
      ...
      <Image src={GeoShield} alt="GeoShield" className={classes.partnerLogo} />
        ...
        <Container>
          <Text size="lg" className={classes.description}>
            Explore the reason behind the growing number of Marietta, GA drivers choosing Supreme Detail Studio for their window tinting needs. We provide the best quality window tint at an unbeatable price, guaranteed!
          </Text>
        </Container>
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 text-base font-semibold leading-7 text-white sm:grid-cols-2 md:flex lg:gap-x-6">
          ...
          <Link to="https://app.urable.com/virtual-shop/rB9FHJFIfifYgU8Ty9Yw/KPFUIkM7NOncFN6UCQoI" target="_blank"  style={{ textDecoration: 'none', display: 'flex', justifyContent: 'center' }}>
          <Button 
...
export default VehicleWindowTintingHero;