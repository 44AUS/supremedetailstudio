...
import HeroVideo from '../../assets/images/exterior-hero.mov';
import ExteriorImage from '../../assets/images/exterior-image.png';
    ...
    <div className={classes.wrapper} data-testid="hero-section">
      ...
      <div className={classes.content}>
        ...
        <Text className={classes.description} data-testid="hero-description">
          At Supreme Detail Studio, we take exterior detailing in Marietta to a whole new level. Our owner, with over a decade of experience, ensures your vehicle will leave our shop looking its absolute best!
        </Text>
