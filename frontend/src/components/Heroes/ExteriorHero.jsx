...
import TeslaFront from '../../assets/images/details/tesla-front.jpg';
...
const useStyles = createStyles((theme) => ({
  wrapper: {
    ...
    paddingTop: '150px',
    paddingBottom: '150px',
    backgroundImage: `url(${TeslaFront})`,
      ...
      <div className={classes.inner}>
        ...
        <Container>
          <Text size="lg" className={classes.description}>
            At Supreme Detail Studio, we take <span style={{ fontWeight: 'bold' }}>exterior detailing in Louisville</span> to a whole new level. Our owner, with almost a decade of experience, ensures your vehicle will leave our shop looking its absolute best!
          </Text>
        </Container>
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 text-base font-semibold leading-7 text-white sm:grid-cols-2 md:flex lg:gap-x-6">
          ...
          <Link to="https://app.urable.com/virtual-shop/rB9FHJFIfifYgU8Ty9Yw/W7VhhrqoAFHJ6GutJHqd" target="_blank"  style={{ textDecoration: 'none', display: 'flex', justifyContent: 'center' }}>
          <Button 
