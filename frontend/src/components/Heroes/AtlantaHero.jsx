      ...
      <Container size="lg">
        <div className={classes.inner}>
          <Title className={classes.smallTitle}>
            ATLANTA'S PREMIER AUTO DETAILING STUDIO
          </Title>
          <Title className={classes.title}>
            AUTO DETAILING IN ATLANTA, GA
          </Title>
          <Text className={classes.description}>
            Experience the finest auto detailing services in Atlanta, Georgia. From ceramic coatings to paint protection film, we deliver showroom-quality results for luxury and exotic vehicles.
          </Text>
          <div className={classes.buttonContainer}>
            <Link 
              ...
              aria-label="Book auto detailing appointment in Atlanta GA"
            >
              Book Appointment
            </Link>
            <Link 
