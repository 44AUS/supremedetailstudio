...
const InteriorDetailing = () => {
  ...
  return (
    <>
    <Helmet>
      <title>Automotive Interior Detailing Louisville, KY | Supreme Detail Studio</title>
      <meta name='title' content='Automotive Interior Detailing Louisville, KY | Supreme Detail Studio' />
      ...
      <meta property="og:title" content='Automotive Interior Detailing Louisville, KY | Supreme Detail Studio' />
    ...
    {/* <ExteriorTable /> */}
      ...
      <div className={classes.wrapper}>
        <Title className={classes.h1} mt="md" mb="md">OUR INTERIOR DETAILING PACKAGES</Title>
        <InteriorDetail />
      </div>
    </Container>
    </>
