...
const AboutPage = () => {
  ...
  return (
    <>
      <Helmet>
      <title>Reputable Car Detailer in Louisville, KY | Auto Detailing Services in Louisville, KY | Supreme Detail Studio</title>
      <meta name='title' content='Reputable Car Detailer in Louisville, KY | Auto Detailing Services in Louisville, KY | Supreme Detail Studio' />
      <meta name='description' content='Supreme Detail Studio is a reputable car detailer in Louisville, KY. Our car care experts provide top quality auto detailing services. Contact our team today to schedule an appointment!' />
      ...
      <meta property="og:title" content='Reputable Car Detailer in Louisville, KY | Auto Detailing Services in Louisville, KY | Supreme Detail Studio' />
      <meta property="og:description" content='Supreme Detail Studio is a reputable car detailer in Louisville, KY. Our car care experts provide top quality auto detailing services. Contact our team today to schedule an appointment!' />
      <meta property="og:image" content='%PUBLIC_URL%/preview.png' />
      ...
      <div className={classes.wrapper}>
        ...
        >
         ...
         <div>
          ...
          <Text className={classes.WhyDesc}>A huge part of our mobile auto detailing services here in Louisville, KY, tire detailing. Your tires take the brunt of the legwork to get you from point A to point B, so they not only need to stay in good shape but also highlight your vehicle in style.</Text>
         ...
         <div>
          ...
          <Text className={classes.WhyDesc}>We also offer wheel curb rash repair, just give us a ring and we’ll discuss what you want and it shall be done! For luxury car detailing services in Louisville, KY, <Link to="/" style={{ textDecoration: 'underline' }}>Supreme Detail Studio</Link> should be on top of your list. Call us now!</Text>
